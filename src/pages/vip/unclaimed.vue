<template>
    <div class="unclaimed_page">
        <vip-pahead :title="'待领取'"></vip-pahead>
        <main>
            <div v-for="i in 10" class="unclaimed_list">
                <div class="box border">
                    <img src="/static/img/vip/remind_success@2x.png">
                    <div>
                        <h5>腾讯DNF黑钻</h5>
                        <p>奖励多奖励</p>
                        <span>2250积分</span>
